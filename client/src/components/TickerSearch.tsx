...
export default function TickerSearch() {
  ...
  return (
    <div ref={wrapRef} className="relative">
      <div className="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg px-3 py-1.5 gap-2 w-64">
      ...
      {open && results.length > 0 && (
        <div className="absolute right-0 mt-1 w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-50 max-h-80 overflow-y-auto">
          {results.map((t: any) => (
            <div
              key={t.symbol}
